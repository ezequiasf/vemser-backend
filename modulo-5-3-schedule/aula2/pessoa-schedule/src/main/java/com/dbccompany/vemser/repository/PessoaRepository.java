...
public class PessoaRepository {
    ...
    public PessoaRepository() {
        ...
        Pessoa p2 = Pessoa.builder()
                .nome("Ezequias")
                .cpf("12133343456")
                .nascimento(LocalDate.parse("18/04/2010", formatter))
                .email("ezequiasbarros1997@gmail.com")
                .build();
        Pessoa p3 = Pessoa.builder()
                .nome("Ezequias com endereco")
                .cpf("12133343456")
                .nascimento(LocalDate.parse("18/04/2010", formatter))
                .email("ezequias.barros@dbccompany.com.br")
                .build();

        pessoas.addAll(List.of(p, p2));
    }
