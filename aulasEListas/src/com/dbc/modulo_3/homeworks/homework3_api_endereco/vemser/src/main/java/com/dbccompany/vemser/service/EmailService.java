...
public class EmailService {
    ...
    public void sendWithAttachment() throws MessagingException {
        ...
        File file1 = new File("src/main/resources/vemser.png");
    ...
    public void sendEmail(DTO dtoGenerico) {
        ...
        try {
            ...
            mimeMessageHelper.setText(geContentFromTemplate(dtoGenerico), true);
